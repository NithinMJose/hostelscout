import './UserHostelDetailPage.css';
...
export const UserHostelDetailPage = () => {
  ...
  const handleBooking = (): void => {
    ...
    console.log('Booking hostel:', id);
    alert('Booking request sent!');
  };

  return (
    <div className="page hostel-detail-page">
      <Link to="/user/hostels" className="btn ghost">← Back to Hostels</Link>
